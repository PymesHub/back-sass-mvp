"""
Django settings for mvp_saas_back project.
...
SECRET_KEY = 'django-insecure-xb8x*fffo6l%#3f*!z5vrhale#n84136ek)1+m#-s&*stgnkpj'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # Asegúrate de usar JWTAuthentication
    ),
}
...
ROOT_URLCONF = 'mvp_saas_back.urls'
...
WSGI_APPLICATION = 'mvp_saas_back.wsgi.application'
